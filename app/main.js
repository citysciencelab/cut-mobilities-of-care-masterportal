...
require.config({
    paths: {
        openlayers: '../../OpenLayers-3.0.0-beta.5/build/ol-whitespace',
        jquery: '../../jQuery-2.0.3/jquery.min',
        jquery_ui: '../../jquery-ui-1.10.4/js/jquery-ui-1.10.4.min',
        jquery_ui_touch: '../../jquery-ui-touch-punch-0.2.3/jquery-ui-touch-punch.min',
        underscore: '../../underscore-1.6.0/underscore.min',
        backbone: '../../backbone-1.1.2/backbone.min',
        text: '../../require-2.1.11/plugins/text-2.0.10/text',
        bootstrap: '../../bootstrap-3.1.1/js/bootstrap.min',
        proj4js: '../../proj4js-1.1.0/proj4js-compressed',
        config: 'config',
