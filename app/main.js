...
require.config({
    paths: {
        openlayers: '../../libs/OpenLayers-3.0.0-beta.5/build/ol-whitespace',
        jquery: '../../libs/jQuery-2.0.3/jquery.min',
        jquery_ui: '../../libs/jquery-ui-1.10.4/js/jquery-ui-1.10.4.min',
        jquery_ui_touch: '../../libs/jquery-ui-touch-punch-0.2.3/jquery-ui-touch-punch.min',
        ...
        proj4js: '../../libs/proj4js-1.1.0/proj4js-compressed',
        config: 'config',
