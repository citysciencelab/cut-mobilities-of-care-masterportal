...
import {generateSimpleGetters} from "../../../store/utils/generators";
...
const getters = {
    ...
    scaleWithUnit: (_, g) => `[placeholder] ${g.projectionUnits || ""}`, // TODO - can probably read how to do this from ScaleLine
