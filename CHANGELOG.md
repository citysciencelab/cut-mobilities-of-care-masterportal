...
- The display of oblique aerial images is no longer supported in Internet Explorer 11, a message appears suggesting to use a current browser for this functionality.
