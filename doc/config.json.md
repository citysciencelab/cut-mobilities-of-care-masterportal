...
|poiDistances|nein|Boolean / [integer]|"true": [500,1000,2000] / "Array": []|Legt fest, ob "In meiner Nähe" geladen wird. Bei Anbgabe eines Array werden zusätzlich die Abstände definiert, die dort angeboten werden.|
