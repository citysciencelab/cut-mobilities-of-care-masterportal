...
|center|Verschiebt den Kartenausschnitt auf die angegebene Adresse. Die Koordinaten müssen dem angegebenen Koordinatensystem angehören (siehe [config.view.epsg](https://bitbucket.org/lgv-g12/lgv/wiki/3.3%20config.js)).|`&center=565874,5934140`|
...
|zoomlevel|Zoomt auf die Maßstabsstufe, die angegeben wurde (siehe [config.view.options](https://bitbucket.org/lgv-g12/lgv/wiki/config.js)).|`&zoomlevel=2`|