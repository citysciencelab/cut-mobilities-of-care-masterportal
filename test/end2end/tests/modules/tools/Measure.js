...
async function MeasureTests ({builder, url, resolution, mode}) {
    ...
    if (testIsApplicable) {
        // TODO feature currently has a bug that's been recorded; reactivate after bug is fixed
        describe.skip("Measure Tool", function () {
            (!is3D(mode) ? describe : describe.skip)("2D measurement", function () {
            ...
            (is3D(mode) ? describe : describe.skip)("3D measurement", function () {
