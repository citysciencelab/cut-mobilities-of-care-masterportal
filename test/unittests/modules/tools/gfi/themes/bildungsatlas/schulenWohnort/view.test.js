...
describe("tools/gfi/themes/bildungsatlas/schulenWohnort/view", function () {
    describe("getFeatureIds", function () {
        it("should add all ids (gotten by school.getId) of schools with the requested area code into the response array", function () {
            ...
            expect(view.getFeatureIds(schools, 123456789)).to.deep.equal([1, 2]);
        });

        it("should return an empty array if schools looks somehow strange", function () {
            expect(view.getFeatureIds(undefined, 123456789)).to.be.empty;
            expect(view.getFeatureIds(false, 123456789)).to.be.empty;
            expect(view.getFeatureIds(null, 123456789)).to.be.empty;
            expect(view.getFeatureIds("foo", 123456789)).to.be.empty;
            expect(view.getFeatureIds(1234, 123456789)).to.be.empty;
            expect(view.getFeatureIds({}, 123456789)).to.be.empty;
            expect(view.getFeatureIds([1, 2, 3, 4])).to.be.empty;
        });
    });
