define([
    ...
    var GrenznachweisModel = Backbone.Model.extend({
        ...
        transmitOrder: function () {
            ...
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("auftragsnummer")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>lagebeschreibung</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("lage")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            ...
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("freitext")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>kundennummer</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundennummer")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            ...
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenname")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>firma</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenfirma")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>adresse</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenadresse")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>plz</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenplz")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>ort</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenort")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input><wps:Input>";
            request_str += "    <ows:Identifier>email</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenemail")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>festnetz</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenfestnetz")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
            request_str += "    <ows:Identifier>mobilfunk</ows:Identifier>";
            request_str += "    <wps:Data>";
            request_str += "      <wps:LiteralData dataType='string'>" + encodeURIComponent(this.get("kundenmobilfunk")) + "</wps:LiteralData>";
            request_str += "    </wps:Data>";
            request_str += "  </wps:Input>";
            request_str += "  <wps:Input>";
