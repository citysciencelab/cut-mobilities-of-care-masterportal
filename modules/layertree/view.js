define([
    ...
    var TreeView = Backbone.View.extend({
        ...
        events: {
            ...
            "click .layer-selection-label  > .control-label, .layer-selection-label > .glyphicon-triangle-bottom, .layer-selection-label > .glyphicon-triangle-right": "toggleSelection",
