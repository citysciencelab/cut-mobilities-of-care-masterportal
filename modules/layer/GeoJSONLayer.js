define([
    ...
    var GeoJSONLayer = Layer.extend({
        ...
        setAttributionLayerSource: function () {
            ...
            this.set("pointSource", new ol.source.Vector());
            this.set("polygonSource", new ol.source.Vector());

            geofeatures = this.get("GeoJSONFormat").readFeatures(this.get("features"));
            _.each(geofeatures, function (feature) {
                if (feature.getGeometry() instanceof ol.geom.Point) {
                    this.get("pointSource").addFeature(feature);
                }
                else if (feature.getGeometry() instanceof ol.geom.Polygon) {
                    this.get("polygonSource").addFeature(feature);
                }
        ...
        setAttributionLayer: function () {
            var pointParams = {
                    ...
                    name: this.get("name"),
                    typ: this.get("typ"),
                    style: this.getStyleForPoint
            },
            polygonParams = {
                    source: this.get("polygonSource"),
                    name: this.get("name"),
                    typ: this.get("typ"),
                    style: this.getStyleForPolygon
            };
        ...
        getStyleForPoint: function (feature) {
        ...
        removeFeatures: function () {
            this.get("pointSource").clear();
            this.get("polygonSource").clear();
        }
    });
