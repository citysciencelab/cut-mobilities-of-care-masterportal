    ...
    */
    var config = {
        ...
        */
        ...
        /**
        * @memberof config
        * @desc Konfiguration des ClickCounters
        * @property {Object} clickCounter Konfigurationsobjekt für den ClickCounter
        * @property {String} clickCounter.version
        * @property {String} clickCounter.desktop URL des iFrame bei Desktopdarstellung
