define([
    ...
    "modules/core/util",
    "backbone.radio"
], function (Backbone, EventBus, Config, ol, Util, Radio) {
...
console.log(8);
            ...
            var layer = Radio.request("ModelList", "getModelByAttributes", {id: "45"});
            console.log(layer);
         ...
         *
         */
        refreshVerkehrsmeldung: function () {console.log(44);
