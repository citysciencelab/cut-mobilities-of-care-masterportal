    ...
    <div class="data-policy-text">
        ...
        <ol id="l1">
                ...
                <ol id="l2">
                    <li><h3 style="padding-left: 27pt;text-indent: -21pt;text-align: left;">Umfang der
                        ...
                        <ul id="l3">
                            ...
                            <li><p class="s3"
                                   style="padding-left: 25pt;text-indent: -18pt;text-align: left;">
                                Familienstand (LD, VH, VW, GS,..)</p></li>
                            <li><p class="s3"
                                   style="padding-left: 25pt;text-indent: -18pt;text-align: left;">
                            ...
                            <li><p class="s3"
                                   style="padding-left: 25pt;text-indent: -18pt;text-align: left;">Um wen
            ...
            <li><h2 style="padding-left: 27pt;text-indent: -21pt;text-align: left;">Verwendung von
                Cookies</h2>
                <p style="text-indent: 0pt;text-align: left;"><br/></p>
                <p style="padding-left: 5pt;text-indent: 0pt;">Die Webseite verwendet
                    keine Cookies.</p>
                <p style="text-indent: 0pt;text-align: left;"><br/></p></li>
            <li><h2 style="padding-left: 27pt;text-indent: -21pt;text-align: left;">Verarbeitung von Daten
                zur Analyse des Surfverhaltens</h2>
                <p style="text-indent: 0pt;text-align: left;"><br/></p>
                <p style="padding-left: 5pt;text-indent: 0pt;">Es findet keinerlei
        ...
        <p style="text-indent: 0pt;text-align: left;"><br/></p>
        <p class="s2" style="padding-left: 5pt;text-indent: 0pt;">Die
        ...
        <ol id="l8">
            <li><h3 style="padding-left: 27pt;text-indent: -21pt;text-align: left;">Auskunftsrecht</h3>
                ...
                <p style="text-indent: 0pt;text-align: left;"><br/></p>
                <p style="padding-left: 5pt;text-indent: 0pt;">Liegt
                ...
                <p style="padding-left: 5pt;text-indent: 0pt;">Ihnen
                    ...
                    werden.</p>
                <p style="text-indent: 0pt;text-align: left;"><br/></p>
                <p style="padding-left: 5pt;text-indent: 0pt;">Dieses
            ...
            <li><h3 style="padding-top: 4pt;padding-left: 27pt;text-indent: -21pt;text-align: left;">Recht
                ...
                <p style="text-indent: 0pt;text-align: left;"><br/></p>
                <p style="padding-left: 5pt;text-indent: 0pt;">Unter
