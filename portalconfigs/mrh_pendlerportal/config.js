define(function () {
    ...
    */
    var config = {
        ...
        * @example wfsImgPath: "../node_modules/lgv-config/img/"
        */
        ...
        * @example layerConf: "../node_modules/lgv-config/services-fhhnet.json"
        */
        layerConf: "../node_modules/lgv-config/services-mrh-test.json",
        /**
        * @memberof config
        * @type {String}
        * @desc Pfad zur json mit Druck- und WPS-Dienst.
        * @example restConf: "../node_modules/lgv-config/rest-services-fhhnet.json"
        */
        ...
        * @example styleConf: "../node_modules/lgv-config/style.json"
        */
